...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick }: SplitFlapCharProps) {
  ...
  const bgColor = isSettled ? "hsla(0, 0.00%, 0.00%, 0.01)" : isDark ? "rgba(122, 22, 55, 0.23)" : "rgba(122, 22, 55, 0.23)"
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 top-0 bottom-1/2 flex items-end justify-center overflow-hidden">
        <span
          className="block translate-y-[0.52em] leading-none transition-colors duration-150 bg-linear-to-r from-pink-500 to-orange-500 bg-clip-text text-transparent"
          style={{
      ...
      <div className="absolute inset-x-0 top-1/2 bottom-0 flex items-start justify-center overflow-hidden">
        <span
          className="-translate-y-[0.52em] leading-none transition-colors duration-150 bg-linear-to-r from-pink-500 to-orange-500 bg-clip-text text-transparent"
          style={{
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
          }}
