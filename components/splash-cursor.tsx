...
export function SplashCursor({
  ...
  useEffect(() => {
    ...
    ): { gl: WebGLRenderingContext | WebGL2RenderingContext; ext: WebGLExt } {
    ...
    function getSupportedFormat(
      ...
      if (!supportRenderTextureFormat(gl, internalFormat, format, type)) {
        // Only check WebGL2-specific formats if we have a WebGL2 context
        if ('R16F' in gl) {
          const gl2 = gl as WebGL2RenderingContext
    ...
    function resizeFBO(
      ...
      copyProgram.bind()
      if (copyProgram.uniforms.uTexture !== null)
    ...
    function updateFrame() {
      if (!isActive || !dye || !velocity || !divergence || !curl || !pressure) return
    ...
    function drawDisplay(target: FBO | null) {
      ...
      if (config.SHADING && displayMaterial.uniforms.texelSize !== null)
        gl.uniform2f(displayMaterial.uniforms.texelSize, 1.0 / width, 1.0 / height)
      if (displayMaterial.uniforms.uTexture !== null)
